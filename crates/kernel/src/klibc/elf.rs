...
impl<'a> ElfFile<'a> {
    ...
    pub fn get_program_headers(&self) -> &[ElfProgramHeaderEntry] {
        ...
        let data = klib::util::slice_from_bytes(
            self.data,
    ...
    fn get_section_headers(&self) -> &[ElfSectionHeader] {
        ...
        klib::util::slice_from_bytes(self.data, offset, count)
    }
    ...
    pub fn find_symbol(&self, address: usize) -> Option<(&str, usize)> {
        ...
        let symbols: &[Elf64Sym] = klib::util::slice_from_bytes(self.data, sym_offset, sym_count);
    ...
    fn check_validity(data: &[u8]) -> Option<ElfParseErrors> {
        ...
        let header: &ElfHeader = klib::util::ref_from_bytes(data);
