//! NS16550-compatible UART driver for the console.
//!
//! The single `CONSOLE_UART` static lives here. Higher layers add semantics
//! on top (TTY line discipline, process-group signal delivery, reboot magic
//! detection) but the hardware access, initialization, and raw read/write
//! primitives are owned by this module.
